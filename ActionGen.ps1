...
$labelDate = New-Object System.Windows.Forms.Label -Property @{ Text = "Select Wednesday:"; Location = New-Object System.Drawing.Point(10, 160); AutoSize = $true }
$comboDate = New-Object System.Windows.Forms.ComboBox -Property @{ Location = New-Object System.Drawing.Point(130, 158); Width = 200; DropDownStyle = "DropDownList" }
...
# Time Selector (12-hour format in 15-minute increments)
$labelTime = New-Object System.Windows.Forms.Label -Property @{ Text = "Select Time:"; Location = New-Object System.Drawing.Point(350, 160); AutoSize = $true }
$comboTime = New-Object System.Windows.Forms.ComboBox -Property @{ Location = New-Object System.Drawing.Point(440, 158); Width = 100; DropDownStyle = "DropDownList" }
...
$btnGenerate.Location = New-Object System.Drawing.Point(270, 210)
...
$btnGenerate.Add_Click({
    ...
    if (-not ($server -and $user -and $pass -and $fixletName -and $selectedDate -and $selectedTime)) {
    ...
    $actions = @(
        ...
        @{
            ...
            Message = "$vendor $app $version will be enforced on $($startDT.AddDays(7).ToString('MM/dd/yyyy h:mm tt')). Please leave your machine on overnight to get the automated update. Otherwise, please close the application and run the update now."
...
<BES>
  <SourcedFixletAction>
    ...
    <Target>
      <ComputerGroupName>Deployment Group</ComputerGroupName>
    </Target>
  </SourcedFixletAction>
</BES>
"@
